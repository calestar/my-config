...
- Ready-to-use [`.editorconfig`](https://github.com/calestar/my-config/blob/master/.editorconfig), [`.dockerignore`](https://github.com/calestar/my-config/blob/master/.dockerignore), and [`.gitignore`](https://github.com/calestar/my-config/blob/master/.gitignore). You don't have to worry about those things.
...
- Everything is already set up for security checks, codestyle checks, code formatting, testing, linting, docker builds, etc with [`Makefile`](https://github.com/calestar/my-config/blob/master/Makefile#L89). More details in [makefile-usage](#makefile-usage).
- [Dockerfile](https://github.com/calestar/my-config/blob/master/docker/Dockerfile) for your package.
...
[`Makefile`](https://github.com/calestar/my-config/blob/master/Makefile) contains a lot of functions for faster development.
...
More information [about docker](https://github.com/calestar/my-config/tree/master/docker).
